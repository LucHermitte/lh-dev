...
" Function: lh#dev#style#spacesinemptyparentheses#__new(name, local, ft) {{{2
function! lh#dev#style#spacesinemptyparentheses#__new(name, local, ft) abort
  let style = lh#dev#style#define_group('spaces.brackets.cf.in_empty', a:name, !a:local, a:ft)
...
function! lh#dev#style#spacesinemptyparentheses#use(styles, value, ...) abort
  ...
  let style = lh#dev#style#spacesinemptyparentheses#__new(a:value, local, ft)
